...
const MenuBar: React.FC<MenuBarProps> = ({ id, saving }) => {
	...
	return (
		<div className="flex w-full py-4 px-8 border-b border-enc-green">
			<Image
				src={Logo}
				alt="logo"
				height={100}
				width={200}
				// className="h-[167px] w-[348px]"
			/>
			<div className="flex items-center justify-center space-x-4 ml-auto mr-20">
				...
				<button className="font-questrial text-2xl font-superthin bg-white text-enc-green border-enc-green border h-16 py-3 px-10 rounded-lg hover:bg-enc-yellow">
					Log Out
				</button>
			</div>
		</div>
