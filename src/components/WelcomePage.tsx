	...
	return (
		...
		>
			<img
				src="logo.png"
				alt="Logo"
				style={{ width: '20%', position: 'relative', top: '-100px' }}
			/>
			<h1 className="absolute top-45 left-1/2 transform -translate-x-1/2 text-center text-black font-bold text-3xl">
				Park History and Attractions
			</h1>
			<h1 className="absolute bottom-28 text-3xl left-1/2 transform -translate-x-1/2 text-center text-gray-800">
